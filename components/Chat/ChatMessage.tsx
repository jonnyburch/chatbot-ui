      ...
      <div
        className={`group px-4 ${
          message.role === 'assistant'
            ? 'bg-green-25 text-green-700 dark:bg-green-700 dark:text-gray-100'
            : ' bg-white text-gray-800 dark:bg-green-800 dark:text-gray-100'
        }`}
        style={{ overflowWrap: 'anywhere' }}
      >
        <div className="relative m-auto flex gap-4 p-4 text-base md:max-w-2xl md:gap-6 md:py-6 lg:max-w-2xl lg:px-0 xl:max-w-3xl">
          <div className="min-w-[65px] text-right font-bold">
            {message.role === 'assistant' ? t('Proggy') : t('You')}:
          </div>
